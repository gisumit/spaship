...
import { Label, List, ListItem, Text, TextContent, TextVariants } from "@patternfly/react-core";
              ...
              <ListItem key={activity.id}>
                <TextContent>
                  <Text component={TextVariants.small}>
                    ...
                    <Label color="green"> {activity.propertyName}</Label> on {activity.envs} at {activity.createdAt}
                    <br />
                  </Text>
                </TextContent>
              </ListItem>
